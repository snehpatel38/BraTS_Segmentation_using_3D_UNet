...
#metrics = [CategoricalAccuracy(), IOUScore(threshold=0.5)]
...
def combined_dice_focal(y_true, y_pred):
...
class CustomMeanIoU(tf.keras.metrics.MeanIoU):
    def __init__(self, num_classes=4, name='mean_iou'):
...
#model.compile(
#    optimizer=optim,
#    loss=combined_dice_focal,
#    metrics=[
#        CategoricalAccuracy(name='categorical_accuracy'),
#        CustomMeanIoU(num_classes=4)
#    ]
#)
...
my_model = load_model('brats_3d.hdf5', 
                      custom_objects={'combined_dice_focal': combined_dice_focal,
